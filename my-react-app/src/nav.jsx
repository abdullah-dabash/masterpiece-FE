    ...
    <nav className="bg-white border-b border-gray-200 dark:bg-gray-900 dark:border-gray-700 fixed top-0 left-0 w-full z-50 shadow-md">
      <div className="max-w-screen-xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="hidden md:flex flex-1 justify-center space-x-8">
          <Link to="/" className="text-gray-700 hover:text-gray-900 dark:text-white dark:hover:text-gray-300">Home</Link>
          <Link to="/contact/ContactUs" className="text-gray-700 hover:text-gray-900 dark:text-white dark:hover:text-gray-300">Contact</Link>
          <Link to="/SignUp" className="text-gray-700 hover:text-gray-900 dark:text-white dark:hover:text-gray-300">Register</Link>
        </div>
        ...
        {/* Cart and Favorite Buttons - Desktop */}
        <div className="hidden md:flex items-center space-x-4 ml-4">
          <Link to="/cart">
            <button className="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-white focus:outline-none">
              <img
      ...
      <div className="md:hidden flex items-center px-4 py-2 border-t border-gray-200 dark:border-gray-700">
        ...
        <Link to="/cart">
          <button className="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-white focus:outline-none ml-2">
            <img
              src="https://icons.veryicon.com/png/o/miscellaneous/swing/shopping-cart-228.png"
              alt="Cart"
              className="w-6 h-6"
